...
//     console.log(
//       `Navigating to ${href} from ${currentPage}`
//     );
...
//             {navItems.map((item) => (
//               <div key={item.name} className="relative" ref={item.name === 'About' ? dropdownRef : null}>
//                 {item.hasDropdown ? (
//                   <div>
//                     <button
...
//                                   onMouseEnter={() => setIsTeamSubmenuOpen(true)}
...
//                     <button
//                       onClick={() => handleNavigation(item.href)}
//                       className={`text-white hover:text-accent font-medium px-2 py-2 text-left ${
//                         currentPage === item.href ? 'text-accent' : ''
//                       }`}
//                     >
//                       {item.name}
...
//                 className="bg-red-600 hover:bg-red-700 text-white mx-2 mt-4 px-4 py-2 rounded-md font-medium transition-colors"
//               >
//                 Apply Now
//               </button>
//             </nav>
